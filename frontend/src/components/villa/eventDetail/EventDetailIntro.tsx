...
import { User, Bed, Bath, Star, Image as ImageIcon, DoorOpen } from "lucide-react"
...
export default function EventDetailIntro({ villa }: EventDetailIntroProps) {
    return (
        <div>
            ...
            <div className="space-y-6">
                ...
                >
                    ...
                    <span className="font-semibold">30 persons</span>
                </div>

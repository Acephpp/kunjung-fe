...
import { BadgePercent, Bath, Bed, Check, ChevronDown, Star, User } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div className="lg:col-span-2 space-y-6">
                ...
                <p className="text-gray-600 max-w-5xl text-[25px] font-secondary mt-10">
                    ...
                    city during your staycation, without needing to move from one house to
                    another.{" "}
                </p>
                ...
                <div className="mt-10">
                    {villa.description.split("\n\n").map((para, idx) => (
                        <p key={idx} className="text-gray-700 mb-4 text-[25px] font-secondary">
                            {para}
                        </p>
                    ))}
                </div>
                ...
                <div>
                    <h2 className="text-[40px] font-primary font-semibold mt-10">Things To-Do</h2>
                    <p className="text-gray-700 mt-3 text-[25px]">{villa.thingsToDo}</p>
                </div>

                <hr className="my-6 border-gray-300 mt-10" />

                <div>
                    <h2 className="text-[40px] font-primary font-semibold mt-10">Amenities</h2>
                ...
                <div>
                    <h2 className="text-[40px] font-primary font-semibold mt-10">Availability</h2>
                ...
                <div>
                    <h2 className="text-[40px] font-primary font-semibold mt-10">Location</h2>
                    <p className="text-gray-700 mt-5 text-[25px] font-secondary">{villa.address}</p>
                    <iframe
                        src={villa.mapUrl}
                        width="100%"
                        height="500"
                    ...
                    <div className="rounded-lg overflow-hidden border border-gray-200 text-sm text-gray-500">
                        ...
                        <div className="grid grid-cols-2 divide-x divide-gray-200 border-b border-gray-200">
                            <div className="flex flex-col p-4 bg-[#F8F7F2] border-[#E7E6E2]">
                                ...
                                <span className="text-gray-400 font-secondary">Add Dates</span>
                            </div>
                            <div className="flex flex-col p-4 bg-[#F8F7F2] border-[#E7E6E2]">
                                <span className="font-medium font-secondary">
                        ...
                        <div className="flex justify-between items-center p-4 bg-[#F8F7F2] border-[#E7E6E2]">
                            <div className="flex flex-col">
                                ...
                                <span className="text-gray-400 font-secondary">Add Guests</span>
                            </div>

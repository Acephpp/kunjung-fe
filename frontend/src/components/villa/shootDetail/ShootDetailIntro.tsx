...
import { Bath, Bed, DoorOpen, ImageIcon, Star, User } from "lucide-react"
import type { villas } from "@/app/data/villas"
import Image from "next/image"

type Villa = (typeof villas)[number]

interface ShootDetailIntroProps {
    villa: Villa
}

export default function ShootDetailIntro({ villa }: ShootDetailIntroProps) {
    return (
        <div>
            ...
            <div className="space-y-6">
                ...
                <div
                    ...
                    px-4 py-2
                    text-sm font-secondary text-[#2D2A29]
                "
                >
                ...
                <div
                    className="
                    font-secondary flex justify-between items-center
                ...
                >
                    ...
                    <div className="w-full sm:w-1/2 sm:pr-4">
                        <div className="relative h-[200px] sm:min-h-[220px] rounded-xl overflow-hidden bg-[#EDEBE6]">
                            <Image
                ...
                <div className="flex items-start gap-4 border-y border-[#E4E1DC] py-5">
                    ...
                    <div>
                        <p className="font-primary font-semibold text-[#2D2A29] text-[18px] md:text-xl">
                            Self check-in
                        </p>
                        <p className="font-primary text-[#6F6C67] text-[14px] md:text-lg">

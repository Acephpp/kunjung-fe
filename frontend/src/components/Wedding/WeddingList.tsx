...
export default function WeddingList() {
    ...
    const handlePageChange = (page: number) => {
        setCurrentPage(page);
        const section = document.getElementById("wedding-list-section");
        if (section) {
    ...
    return (
        <section id="wedding-list-section" className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-10 py-5 mx-auto pb-5 md:pb-20 font-secondary scroll-mt-32">
            {/* Header */}
            <h2
                className="
            ...
            "
            >
                {villas.length} Houses for Your Special Day
            </h2>

            ...
            <div className="bg-[#FCFBF7] rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.15)] border border-gray-200 overflow-hidden">
                ...
                <div className="flex w-full border-b border-gray-200 relative rounded-t-3xl overflow-hidden">
                    <button
                        ...
                        className={`flex-1 py-4 text-lg font-semibold text-center transition-all duration-300 ${
                            activeTab === "upcoming"
                ...
                {/* === Content === */}
                {activeTab === "upcoming" ? (
                    // ==== UPCOMING: list reservation cards ====
                        ...
                        {villas.slice(0, 2).map((villa, index) => (
                            ...
                            >
                                ...
                                <div className="relative md:w-[35%] p-5">
                                    ...
                                    <span
                                        className={`absolute bottom-8 left-8 px-3 py-[2px] text-xs font-medium rounded-md capitalize ${
                                            index === 0
                                ...
                                <div className="flex-1 flex flex-col md:flex-row justify-between p-6 md:pr-8">
                                    ...
                                    <div className="text-gray-700 md:w-[55%] flex flex-col h-full">
                                        <div>
                                            <h2 className="text-[40px] font-primary">
                                                {villa.name}
                                            </h2>
                    ...
                    // ==== COMPLETED: empty-state view ====
                    <div className="py-24 px-10 flex flex-col items-center justify-center text-center">
                        <h2 className="font-primary text-[36px] md:text-[46px] lg:text-[52px] leading-tight text-[#1E1E1E]">
                            Feel the needs
                            <br />
                            to discover new things?
                        </h2>
                        <p className="mt-4 text-[14px] md:text-[15px] font-semibold text-gray-500">
                            Explore house and services.
                            <br />
                            When you book, your reservations will show up here.
                        </p>
                        <button className="mt-8 px-8 py-3 rounded-full bg-[#7A3E2C] text-white text-[15px] font-medium hover:bg-[#693424] transition">
                            start exploring
                        </button>
                    </div>
                )}

...
function ShootSearchBarContent() {
    ...
    return (
        <div ref={dropdownRef} className={`z-[45] w-full transition-all duration-300 lg:relative lg:top-0 lg:bg-transparent lg:border-b-0 lg:backdrop-blur-none backdrop-blur-sm bg-[#FCFBF7]/80 border-b border-gray-200 ${showNavbar ? "sticky top-16" : "sticky top-0"}`}>
            {/* ================= MOBILE SEARCH BAR ================= */}
